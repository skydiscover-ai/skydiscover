...
uv run skydiscover-run initial_prompt.txt eval -c config_adaevolve.yaml -i 100  # AdaEvolve
uv run skydiscover-run initial_prompt.txt eval -c config_evox.yaml -i 100       # EvoX
```
